...
//            catch (Exception Exp)
//            {
//                ErrorLogging.LogError(viewModel.SelectedProduct.Product + "\\" + viewModel.SelectedSample.SampleName + "-" + Exp.Message + "\n" + Exp.StackTrace);
//            }
...
//            catch(Exception e)
//            {
//                ErrorLogging.LogError(viewModel.SelectedProduct.Product + "\\" + viewModel.SelectedSample.SampleName + "-" + e.Message + "\n" + e.StackTrace);
//            }
